      ...
      if (formato === 'CSV') exportarCSV(columnas, filas, nombreBase)
        ...
        await generarCuentaCobroPDF({
          ...
          empresa: {
            ...
            ciudad: configuracion?.ciudad ?? null,
            nit: configuracion?.nit ?? null,
            instagram: configuracion?.instagram ?? null,
            facebook: configuracion?.facebook ?? null,
            tiktok: configuracion?.tiktok ?? null,
            whatsapp: configuracion?.whatsapp ?? null,
            sitioWeb: configuracion?.sitio_web ?? null,
            representanteLegalNombre: configuracion?.representante_legal_nombre ?? null,
            representanteLegalDocumento: configuracion?.representante_legal_documento ?? null,
          },
          periodo: { desde, hasta },
          lineas: filas.map((f) => ({
            producto: f.producto,
